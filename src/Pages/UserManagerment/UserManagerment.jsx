...
const UserManagerment = () => {
...

        {
            ...
            render: (record) => (
                <div>
                    <button
                        onClick={() => {
                            handelEditProject(record.userId);
                        }}
    ...
    let handelEditProject = async (userId) => {
                ...
                >
                    <form className="space-y-4 md:space-y-6 text-black" action="#" onSubmit={handleSubmit}>
                        <InputCustom touched={touched.id} onBlur={handleBlur} value={values.id}
                            className='mt-0 mb-2 ' name={"id"} label={"User ID"} placeholder={"Type Project ID"} />
